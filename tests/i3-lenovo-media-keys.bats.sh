...
for binding in \
  'XF86AudioRaiseVolume exec --no-startup-id volume-osd up' \
  'XF86AudioLowerVolume exec --no-startup-id volume-osd down' \
  'XF86AudioMute exec --no-startup-id volume-osd mute' \
  'XF86AudioMicMute exec --no-startup-id mic-volume-osd mute' \
  'XF86MonBrightnessUp exec --no-startup-id brightness-osd up' \
  'XF86MonBrightnessDown exec --no-startup-id brightness-osd down' \
  'XF86WLAN exec --no-startup-id i3-wifi-toggle' \
  'XF86RFKill exec --no-startup-id i3-wifi-toggle'; do
