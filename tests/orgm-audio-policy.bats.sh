...
policy="$(nix eval --json "path:$ROOT#nixosConfigurations.orgm-cinnamon.config.services.pipewire.wireplumber.extraConfig.\"90-orgm-audio-policy\"")"
...
service="$(nix eval --json "path:$ROOT#nixosConfigurations.orgm-cinnamon.config.systemd.user.services.wireplumber-orgm-default-audio")"
