...
let
  windowsManagerLinuxOrgm = pkgs.callPackage ./windows-manager-linux-orgm.nix { };
  signedWindowsManagerLinuxOrgm = ./windows-manager-linux-orgm/windows-manager-linux-orgm-signed-1.0.6.xpi;
