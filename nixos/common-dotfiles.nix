...
GTKEOF
        ...
        + lib.optionalString (profileName == "hyprlandqs-caelestia") ''
          init_file ".config/caelestia/shell.json" '{"bar":{"workspaces":{"shown":10}},"general":{"idle":{"timeouts":[{"timeout":180,"idleAction":"lock"},{"timeout":300,"idleAction":"dpms off","returnAction":"dpms on"},{"timeout":600,"idleAction":["suspend"]}]}}}'
