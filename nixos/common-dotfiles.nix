...
let
  ...
  hostPaths = {
    ...
    orgm = [
      ...
      ".local/share/applications/omp.desktop"
      ".local/share/applications/pi.desktop"
      ".local/share/applications/reddit.desktop"
      ".local/share/applications/silksong.desktop"
      ".local/share/icons/omp.svg"
      ".local/share/icons/opencode.svg"
      ".local/share/icons/reddit.svg"
    ]
    ++ hostIconSubdirs;
    jarq = [
