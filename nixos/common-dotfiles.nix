...
let
  ...
  sharedPaths = [
    ...
    ".config/fish/functions/bun.fish"
    ...
    ".config/fish/functions/nvim.fish"
    ".config/fish/functions/orgm-dot.fish"
    ".config/fish/functions/pi.fish"
    ".config/fish/functions/pnpm.fish"
    ...
    ".config/fish/functions/zeditor.fish"
  ...
  profileSpecificPaths = {
    ...
    hyprlandqs-yahr = [
      ...
      ".config/qt5ct/colors/caelestia.colors"
      ".config/qt6ct/colors/caelestia.colors"
      ".config/quickshell/AdvancedExamples.qml"
      ".config/quickshell/AppLauncher.qml"
      ".config/quickshell/ArchButton.qml"
      ".config/quickshell/Audio.qml"
      ".config/quickshell/Bar.qml"
      ".config/quickshell/BarIslandGroup.qml"
      ".config/quickshell/Battery.qml"
      ".config/quickshell/CalendarState.qml"
      ".config/quickshell/CalendarTab.qml"
      ".config/quickshell/CalendarWidget.qml"
      ".config/quickshell/ClipboardManager.qml"
      ".config/quickshell/ClipboardPanel.qml"
      ".config/quickshell/Clock.qml"
      ".config/quickshell/ControlCenter.qml"
      ".config/quickshell/FilesButton.qml"
      ".config/quickshell/FirefoxButton.qml"
      ".config/quickshell/IconButton.qml"
      ".config/quickshell/KittyButton.qml"
      ".config/quickshell/MediaPlayer.qml"
      ".config/quickshell/Network.qml"
      ".config/quickshell/PowerButton.qml"
      ".config/quickshell/PowerMenu.qml"
      ".config/quickshell/QuickAccessDrawer.qml"
      ".config/quickshell/ScreenshotButton.qml"
      ".config/quickshell/ScreenshotWidget.qml"
      ".config/quickshell/Separator.qml"
      ".config/quickshell/SettingsButton.qml"
      ".config/quickshell/SettingsWidget.qml"
      ".config/quickshell/settings.json"
      ".config/quickshell/shell.qml"
      ".config/quickshell/SparklineChart.qml"
      ".config/quickshell/SystemInfoWidget.qml"
      ".config/quickshell/SystemTab.qml"
      ".config/quickshell/SystemTray.qml"
      ".config/quickshell/ThemeButton.qml"
      ".config/quickshell/ThemeLoadingOverlay.qml"
      ".config/quickshell/ThemeManager.qml"
      ".config/quickshell/ThemePreview.qml"
      ".config/quickshell/ThemeSwitcher.qml"
      ".config/quickshell/TrayDrawer.qml"
      ".config/quickshell/Updates.qml"
      ".config/quickshell/WallpaperButton.qml"
      ".config/quickshell/WallpaperPicker.qml"
      ".config/quickshell/WallpaperPickerBridge.qml"
      ".config/quickshell/WallpaperPickerContent.qml"
      ".config/quickshell/WallpaperPickerManager.qml"
      ".config/quickshell/WeatherTab.qml"
      ".config/quickshell/WorkspaceBar.qml"
      ".config/quickshell/modules"
      ".config/quickshell/theme/orgm-dark.json"
      ".config/quickshell/theme/orgm-light.json"
  ...
  # Source: dotfiles/config/hosts/<host>/<path>
  hostProfilePaths = {
    ero    = { hyprland = []; i3 = []; labwc = []; hyprlandqs-yahr = []; hyprlandqs-caelestia = []; };
    jarq   = { hyprland = []; i3 = []; labwc = []; hyprlandqs-yahr = []; hyprlandqs-caelestia = []; };
    lenovo = {
      hyprland = [
  ...
  home-manager.users.${userName} =
    { config, lib, pkgs, ... }:
    {
      ...
      home.activation.initGeneratedConfigs = lib.hm.dag.entryAfter [ "linkGeneration" ] (
        ...
        ''
        + lib.optionalString (profileName == "hyprlandqs-yahr") ''
          init_file ".config/rofi/orgm-current.rasi"             "/* generated by orgm-themes */"
          init_file ".config/gtk-4.0/gtk.css"      "/* generated by orgm-themes */"
          init_file ".config/gtk-4.0/gtk-dark.css" "/* generated by orgm-themes */"
          init_file ".config/qt5ct/qt5ct.conf"     ""
