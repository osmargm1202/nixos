...
func TestRenderOrgmLightFixtureActiveFiles(t *testing.T) {
	themesDir := filepath.Join("..", "..", "dotfiles", "config", "profiles", "hyprland", ".config", "orgm-theme", "themes")
...
func TestRenderWaybarHyprLightIconOverrides(t *testing.T) {
	theme, err := LoadTheme(filepath.Join("..", "..", "dotfiles", "config", "profiles", "hyprland", ".config", "orgm-theme", "themes"), "orgm-light")
	if err != nil {
		t.Fatalf("LoadTheme orgm-light fixture error = %v", err)
	}
...
func TestRenderSwayNCUsesWaybarPalette(t *testing.T) {
	for _, themeName := range []string{"orgm-dark", "orgm-light"} {
		t.Run(themeName, func(t *testing.T) {
			theme, err := LoadTheme(filepath.Join("..", "..", "dotfiles", "config", "profiles", "hyprland", ".config", "orgm-theme", "themes"), themeName)
			if err != nil {
...
func TestRenderWaybarHyprDarkUsesPanelBG(t *testing.T) {
	theme, err := LoadTheme(filepath.Join("..", "..", "dotfiles", "config", "profiles", "hyprland", ".config", "orgm-theme", "themes"), "orgm-dark")
	if err != nil {
