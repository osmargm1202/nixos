...
func KeybindingCategories() []KeybindingCategory {
	return []KeybindingCategory{
		{ID: "launchers", Title: "Launchers", Icon: "󰀻", Entries: []KeybindingEntry{{"Win+/", "Atajos Hyprland", "orgm-hypr helper toggle"}, {"Win+Enter", "Terminal", "kitty"}, {"Win+Space", "Menú principal", "orgm-hypr launcher apps"}, {"Win+A", "Buscar / ChatGPT", "orgm-hypr smart-run run"}, {"Win+E", "Explorador de archivos", "orgm-hypr file open-dir --launcher fuzzel"}, {"Win+O", "Obsidian", "orgm-hypr obsidian open-or-focus"}}},
