...
for cfg in "$ROOT/config/profiles/hyprland/.config/waybar-hypr/config" "$ROOT/config/profiles/labwc/.config/waybar/config"; do
  ...
  assert_contains "$cfg" '"on-click": "kitty --class nixclean -e bash -c'
done

for css in "$ROOT/config/profiles/hyprland/.config/waybar-hypr/style.css" "$ROOT/config/profiles/labwc/.config/waybar/style.css"; do
