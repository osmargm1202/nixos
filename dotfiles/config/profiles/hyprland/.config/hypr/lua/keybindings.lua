...
function M.setup(programs)
  ...
  hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("hypr-chromium-new-window"))
  ...
  hl.bind(mainMod .. " + Print", hl.dsp.exec_cmd("record_screen_mp4"))
  hl.bind(mainMod .. " + SHIFT + Print", hl.dsp.exec_cmd("record_screen_gif"))
